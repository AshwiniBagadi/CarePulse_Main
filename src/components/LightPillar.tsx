...
export default function LightPillar({
  ...
  useEffect(() => {
    ...
    const qualitySettings: Record<LightPillarQuality, { iterations: number, waveIterations: number, pixelRatio: number, precision: 'highp' | 'mediump', stepMultiplier: number }> = {
